                                    ...
                                    countQuery.get(AggregateSource.SERVER)
                                        .addOnCompleteListener { task ->
                                            if (task.isSuccessful) {
                                                ...
                                                countQuery1.get(AggregateSource.SERVER)
                                                    .addOnCompleteListener { tasks ->
                                                        if (tasks.isSuccessful) {
                                                            ...
                                                            countQuery2.get(AggregateSource.SERVER)
                                                                .addOnCompleteListener { taskss ->
                                                                    if (taskss.isSuccessful) {
                                                                        val snapshot2 =
                                                                            taskss.result
                                                                        orderDetailSize =
                                                                            snapshot2.count.toInt()
                                                                        orderDetailSize += 1
                                                                        ...
                                                                        countQuery3.get(
                                                                            ...
                                                                            .addOnCompleteListener { taskssx ->
                                                                                if (taskssx.isSuccessful) {
                                                                                    val snapshot3 =
                                                                                        taskssx.result
                                                                                    transSize =
                                                                                        snapshot3.count.toInt()
                                                                                    transSize += 1
                                                                                    ...
                                                                                    if (orderDetailSize < 10) {
                                                                                        detailid =
                                                                                            "ORD0000$orderDetailSize"
                                                                                    } else if (orderDetailSize < 100) {
                                                                                        detailid =
                                                                                            "ORD000$orderDetailSize"
                                                                                    } else if (orderDetailSize < 1000) {
                                                                                        detailid =
                                                                                            "ORD00$orderDetailSize"
                                                                                    } else if (orderDetailSize < 10000) {
                                                                                        detailid =
                                                                                            "ORD0$orderDetailSize"
...
*/
                                                                                                    ...
                                                                                                    val washingtonRef2 =
                                                                                                        db.collection(
                                                                                                            ...
                                                                                                            .document(
                                                                                                                walletObj.walletID.toString()
                                                                                                            )
                                                                                                    washingtonRef2
                                                                                                        .update(
                                                                                                            "balance",
                                                                                                            walletObj.balance!! - sub
                                                                                                        )
